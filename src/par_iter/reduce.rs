...
struct ReduceConsumer<'r, REDUCE_OP: 'r, ITEM> {
...
impl<'r, REDUCE_OP, ITEM> Reducer for ReduceConsumer<'r, REDUCE_OP, ITEM>
    where REDUCE_OP: ReduceOp<ITEM>,
{
    type Result = ITEM;
...
impl<'r, REDUCE_OP, ITEM> Folder for ReduceFolder<'r, REDUCE_OP, ITEM>
    where REDUCE_OP: ReduceOp<ITEM>,
{
    type Item = ITEM;
    type Result = ITEM;
